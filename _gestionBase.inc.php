...
{
   $req="select idformation, nomformation, description, dateformation from formation order by idformation";
   return $req;
}
function modifierformation($id)
{
   $req="select idformation, nomformation, description, dateformation from formation  where idformation='$id'";
   return $req;
}
function afficherpersonnel()
{
   $req="select idpersonnel, nompersonnel, adressepersonnel, codepostale, ville, datenaiss, salaire from personnel order by idpersonnel";
   return $req;
}

function modifierpersonnel($id)
{
   $req="select idpersonnel, nompersonnel, adressepersonnel, codepostale, ville, datenaiss, salaire from personnel where idpersonnel='$id'";
   return $req;
}

function afficherorganisateur()
{
   $req="select idorganisateur, nomorganisatuer, ville, datenaiss, salaire from organisateur order by idorganisateur";
   return $req;
}
function modifierorganisateur($id)
{
   $req="select idorganisateur, nomorganisatuer, ville, datenaiss, salaire from organisateur where idorganisateur='$id'";
   return $req;
}
...
function obtenirDetailformation($connexion, $id)
{
