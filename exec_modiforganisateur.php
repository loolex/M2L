...
$nomorganisateur=$_POST['nomorganisatuer'];
$ville=$_POST['ville'];
$datenaiss=$_POST['datenaiss'];
$salaire=$_POST['salaire'];

$sql="UPDATE organisateur SET nomorganisatuer = '$nomorganisateur', ville = '$ville',datenaiss = '$datenaiss',salaire = '$salaire' WHERE idorganisateur = $id";
