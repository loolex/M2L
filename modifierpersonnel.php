...
// affiche les valeurs précédemment contenues dans le formulaire
   ...
   // BOUCLE SUR LES ÉTABLISSEMENTS
      ...
      $nompersonnel=$lgEtab['nompersonnel'];
...
echo "
<form method='POST' action='exec_modifpersonnel.php?idpersonnel=$id'>
   <input type='hidden' value='validerModifEtab' name='action'>
   <table class='table table-striped'>
   
      <tr class='enTeteTabNonQuad'>
         <td colspan='3'>$nompersonnel ($id)</td>
     
         <td><input type='hidden' value='$id' name='idpersonnel'></td>
      </tr>";
      
      echo '
      <tr class="ligneTabNonQuad">
         <td> Nom*: </td>
         <td><input type="text" value="'.$nompersonnel.'" name="nompersonnel" size="50" 
         maxlength="45"></td>
      </tr>
      <tr class="ligneTabNonQuad">
         <td> Adresse: </td>
         <td><input type="text" value="'.$adressepersonnel.'" name="adressepersonnel" 
         size="50" maxlength="45"></td>
      </tr>
      <tr class="ligneTabNonQuad">
         <td> Code Postal: </td>
         <td><input type="text" value="'.$codepostale.'" name="codepostale" size="50" 
         maxlength="45"></td>
